...
public class MLRMFluids {
    ...
    public static final FluidRegistryObject<FluidDeferredRegister.MekanismFluidType, ForgeFlowingFluid.Source, ForgeFlowingFluid.Flowing, LiquidBlock, BucketItem> PLUTONIUM = FLUIDS.registerLiquidChemical(MLRMChemicalConstants.PLUTONIUM);
    public static final FluidRegistryObject<FluidDeferredRegister.MekanismFluidType, ForgeFlowingFluid.Source, ForgeFlowingFluid.Flowing, LiquidBlock, BucketItem> POLONIUM = FLUIDS.registerLiquidChemical(MLRMChemicalConstants.POLONIUM);
    public static final FluidRegistryObject<FluidDeferredRegister.MekanismFluidType, ForgeFlowingFluid.Source, ForgeFlowingFluid.Flowing, LiquidBlock, BucketItem> SPENT_NUCLEAR_WASTE = FLUIDS.registerLiquidChemical(MLRMChemicalConstants.SPENT_NUCLEAR_WASTE);
